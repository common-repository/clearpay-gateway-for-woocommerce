...
final class WC_Gateway_Clearpay_Blocks_Support extends AbstractPaymentMethodType {
	...
	public function initialize() {
		$this->settings = get_option( 'woocommerce_clearpay_settings', array() );
	}
	...
	public function get_payment_method_script_handles() {
		$asset_path   = WC_GATEWAY_CLEARPAY_PATH . '/build/clearpay-blocks/index.asset.php';
		...
		wp_register_script(
			...
			WC_GATEWAY_CLEARPAY_URL . '/build/clearpay-blocks/index.js',
			$dependencies,
			$version,
			true
		);
		return array( 'wc-clearpay-blocks-integration', 'clearpay_express' );
	}
